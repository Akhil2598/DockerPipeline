...
node {
    ...
    stage('Push to Docker Registry'){
        withCredentials([usernamePassword(credentialsId: 'dockerHubAccount', usernameVariable: 'Akhil2598', passwordVariable: 'Nani2598')]) {
            sh "docker login -u $Akhil2598-p $Nani2598"
